...
@section("content")
    ...
    <h1 class="title">AVISO LEGAL</h1>
            ...
            <p>
                Mercatavico , S.L. se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer
            ...
            <ul>
                ...
                <li>Denominación social: Mercatavico</li>
                <li>NIF: 000000</li>
                <li>Domicilio social: Parque Empresarial ​Mercatavico , 0000 Ferrol (A Coruña)</li>
            ...
            <p>
                ...
                redirigir al sitio web principal de Mercatavico.com.
            </p>
            <p>
                El RESPONSABLE reconoce a favor de sus titulares los correspondientes derechos de propiedad intelectual
                e industrial, no implicando su sola mención o aparición en el sitio web la existencia de derechos o
            ...
            <p>
                ...
                imprescindibles para el correcto funcionamiento y visualización del sitio. Las cookies utilizadas
                tienen, en todo caso, carácter temporal, con la única finalidad de hacer más eficaz la navegación, y
                desaparecen al terminar la sesión del usuario. En ningún caso, estas cookies proporcionan por sí mismas
                datos de carácter personal y no se utilizarán para la recogida de estos.
            </p>
            <p>
            ...
            <p>
                Este sitio web utiliza cookies propias y de terceros para mostrarle publicidad personalizada en base a
                un perfil elaborado a partir de sus hábitos de navegación (por ejemplo, páginas visitadas). A todo
                usuario que visita la web se le informa del uso de estas cookies mediante un banner flotante. En el caso
                de aceptar su uso, el banner desaparecerá, aunque en todo momento podrá revocar el consentimiento y
            ...
            <p>
                ...
                procederá a la retirada inmediata de cualquier contenido que pudiera contravenir la legislación nacional
                o internacional, la moral o el orden público, procediendo a la retirada inmediata de la redirección a
                dicho sitio web, poniendo en conocimiento de las autoridades competentes el contenido en cuestión.
            </p>
            <p>
                ...
                susceptible de esta clasificación, se ruega lo notifique de forma inmediata al administrador del sitio
                web.
            </p>
            <p>
                ...
                RESPONSABLE no descarta la posibilidad de que existan ciertos errores de programación, o que acontezcan
