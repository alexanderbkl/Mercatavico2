        ...
        @if (count($materials) > 0)
            @foreach ($materials as $material)
                <tr>
                    ...
                    <td>{{ $material->name }}</td>
                    <td>
                        <button class="btn btn-success edit_material" data-toggle="modal" data-target="#modalEditMaterial"
                            data-name="{{ $material->name }}" data-id="{{ $material->id }}">Editar</button>
                        <button class="btn btn-danger deleteMaterial" data-id="{{ $material->id }}" data-toggle="modal"
                            data-target="#confirmDeleteMaterialModal">Eliminar</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="row" style="width: 100%">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="material_name_edit"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnUpdateMaterial" data-dismiss="modal">Guardar
                    material</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="confirmDeleteMaterialModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-primary" id="confirm_delete_material_btn"
