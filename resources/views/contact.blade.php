            ...
            <div class="contact">
                ...
                <form class="form">
                    ...
                    <div class="phone">
                        ...
                        <span class="input"><input type="text" id="phone" name="phone" maxlength="32"
                    ...
                    <div class="message">
                        ...
                        <span class="textarea">
                            <textarea rows="4" cols="50" type="text" id="message" name="msg" maxlength="512" required></textarea>
                        </span>
                        <ul class="errors"></ul>
                    </div>
                    <br>
                    ...
                    <div class="form-group" style="display: flex">
                        <label>Acepto </label>
                        <input style="width: 20px;margin-left: 10px" type="checkbox" id="agree" name="agree"
